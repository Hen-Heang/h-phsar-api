...
//    Category insertCategory(Integer storeId, Integer categoryId);
    ...
    @Result(property = "name", column = "category_id",
            one = @One(select = "com.henheang.hphsar.repository.CategoryRepository.getCategoryNameById"))
    @Result(property = "createdDate", column = "category_id",
            one = @One(select = "com.henheang.hphsar.repository.CategoryRepository.getCategoryCreatedDateById"))
    @Result(property = "updatedDate", column = "category_id",
            one = @One(select = "com.henheang.hphsar.repository.CategoryRepository.getCategoryUpdatedById"))
