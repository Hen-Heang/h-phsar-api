...
//    @Result(property = "qty", column = "{productId=product_id , date=date, storeId=store_id}", one = @One(select = "com.henheang.hphsar.repository.HistoryRepository.getImportDetailQty"))
//    @Result(property = "price", column = "{productId=product_id , date=date, storeId=store_id}", one = @One(select = "com.henheang.hphsar.repository.HistoryRepository.getImportDetailPrice"))
//    @Result(property = "total", column = "{productId=product_id , date=date, storeId=store_id}", one = @One(select = "com.henheang.hphsar.repository.HistoryRepository.getImportDetailTotal"))
...
//    List<ImportHistory> getProductImportHistoryASC(Integer pageNumber, Integer pageSize, Integer storeId);
    @Select("""
            SELECT tb_product_import_detail.product_id AS id,
                               ...
                               (SELECT created_date FROM tb_product_import WHERE id = tb_product_import_detail.product_import_id) AS date,
...
//    List<ImportHistory> getProductImportHistoryDESC(Integer pageNumber, Integer pageSize, Integer storeId);
    ...
    @Result(property = "image", column = "retailerId",
            one = @One(select = "com.henheang.hphsar.repository.RetailerProfileRepository.getRetailerImageById"))
    ...
    @Result(property = "name", column = "storeId",
            one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getStoreNameById"))
    @Result(property = "image", column = "storeId",
            one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getStoreImageByStoreId"))
    @Result(property = "address", column = "retailerId",
            one = @One(select = "com.henheang.hphsar.repository.RetailerProfileRepository.getRetailerAddressById"))
    @Result(property = "total", column = "id",
            one = @One(select = "com.henheang.hphsar.repository.OrderDistributorRepository.getTotalOrderAmount"))
