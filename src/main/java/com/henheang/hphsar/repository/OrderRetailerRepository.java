...
//            one = @One(select = "com.henheang.hphsar.repository.OrderRetailerRepository.getOrderByOrderId"))
////    @Result(property = "products", column = "id",
////            many = @Many(select = "com.henheang.hphsar.repository.OrderRetailerRepository.getProductOrderByOrderIdASC",
