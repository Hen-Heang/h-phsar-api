...
public interface StoreRepository {
    ...
    @Select("""
            ...
            VALUES (DEFAULT, #{currentUserId}, #{store.name}, #{store.description}, DEFAULT, DEFAULT, true, DEFAULT, #{store.bannerImage}, #{store.address}, #{store.primaryPhone})
    ...
    @Result(property = "rating", column = "id",
            one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getRating"))
    @Result(property = "ratingCount", column = "id",
            one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getRatingCount"))
    ...
    @Result(property = "ratingCount", column = "id",
            one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getRatingCount"))
    @Result(property = "additionalPhone", column = "id", many = @Many(select = "com.henheang.hphsar.repository.StoreRepository.getAdditionalPhone"))
    ...
    @Result(property = "ratingCount", column = "id",
            one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getRatingCount"))
    @Result(property = "additionalPhone", column = "id", many = @Many(select = "com.henheang.hphsar.repository.StoreRepository.getAdditionalPhone"))
    @Result(property = "categories", column = "id", many = @Many(select = "com.henheang.hphsar.repository.StoreRepository.getCategoryListingByStoreId"))
    ...
    @Select("""
            SELECT td.store_id    AS storeId,
                   ...
                   td.description,
                   td.category_id,
                   td.is_publish  AS isPublish,
                   td.created_date AS createdDate,
                   td.updated_date AS updatedDate
            FROM tb_store_product_detail td
                     INNER JOIN tb_product tp ON td.product_id = tp.id
            WHERE td.store_id = #{storeId}
            AND td.is_publish = true
            ORDER BY ${by} ASC;
             """)
    @Result(property = "category", column = "category_id", one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getCategoryByCategoryId"))
    ...
    @Select("""
            SELECT tb_store.id                     AS id,
                   ...
                   tb_store.created_date           AS createdDate,
                   tb_store.updated_date           AS updatedDate,
