...
public interface OrderDistributorRepository {
    ...
    @Result(property = "name", column = "retailerId",
            one = @One(select = "com.henheang.hphsar.repository.RetailerProfileRepository.getRetailerNameById"))
    @Result(property = "address", column = "retailerId",
            one = @One(select = "com.henheang.hphsar.repository.RetailerProfileRepository.getRetailerAddressById"))
    @Result(property = "total", column = "id",
            one = @One(select = "com.henheang.hphsar.repository.OrderDistributorRepository.getTotalOrderAmount"))
    @Result(property = "status", column = "status_id",
            one = @One(select = "com.henheang.hphsar.repository.OrderDistributorRepository.getStatusByStatusId"))
    @Result(property = "retailerImage", column = "retailerId", one = @One(select = "com.henheang.hphsar.repository.RetailerProfileRepository.getRetailerImageById"))
    @Result(property = "storeImage", column = "storeId", one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getStoreImageById"))
    @Result(property = "storeName", column = "storeId", one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getStoreNameById"))
    @Result(property = "storeAddress", column = "storeId", one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getStoreAddressById"))
    @Result(property = "storePrimaryPhone", column = "storeId", one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getStorePrimaryPhoneById"))
    @Result(property = "storeAdditionalPhone", column = "storeId", many = @Many(select = "com.henheang.hphsar.repository.StoreRepository.getAdditionalPhone"))
    @Result(property = "retailerPhone", column = "retailerId", one = @One(select = "com.henheang.hphsar.repository.RetailerProfileRepository.getRetailerPhoneById"))
    @Result(property = "retailerEmail", column = "retailerId", one = @One(select = "com.henheang.hphsar.repository.RetailerProfileRepository.getRetailerEmailById"))
    @Result(property = "storeEmail", column = "storeId", one = @One(select = "com.henheang.hphsar.repository.StoreRepository.getStoreEmailByStoreId"))
    ...
    @Result(property = "order", column = "id",
            one = @One(select = "com.henheang.hphsar.repository.OrderDistributorRepository.getOrderByOrderId"))
    @Result(property = "products", column = "id",
            many = @Many(select = "com.henheang.hphsar.repository.OrderDistributorRepository.getProductOrderForOrderDetail"))
    ...
    @Result(property = "order", column = "id",
            one = @One(select = "com.henheang.hphsar.repository.OrderDistributorRepository.getOrderByOrderId"))
    @Result(property = "products", column = "id",
            many = @Many(select = "com.henheang.hphsar.repository.OrderDistributorRepository.getProductOrder"))
